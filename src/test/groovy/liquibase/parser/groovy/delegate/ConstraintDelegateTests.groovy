 ...
 */
class ConstraintDelegateTests extends IntegrationTest {
	...
	void fullArgumentsNoClosure() {
		def action = parseAction("""
			createTable(tableName: 'myTable') {
				column(name: 'columnName', type: 'varchar(30)') {
					constraints(
						nullable: true,
						primaryKey: true,
                        ...
                        referencedTableCatalog: 'catalog',
...
//		assertTrue constraint instanceof ConstraintsConfig
	 ...
	 * Expect our ParseException with a good message instead of
	 ...
	 * closure. Expect our ParseException with a good message instead of
	 * Liquibase's RuntimeException
	 */
	@Test(expected = ParseException)
